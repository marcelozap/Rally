...
enum Tunables {
    ...
    static let wallStrikeGateQuietAlpha: CGFloat = 0.035
    static let wallStrikeGateFillAlpha: CGFloat = 0.0
    static let wallStrikeGateStrokeAlpha: CGFloat = 0.22
    static let wallStrikeGateApproachStrokeAlpha: CGFloat = 0.18
    static let wallStrikeGateGlowBase: CGFloat = 0.2
    static let wallStrikeGateApproachGlow: CGFloat = 2.2
    static let wallStrikeGateApproachXScale: CGFloat = 0.10
    static let wallStrikeGateApproachYScale: CGFloat = 0.05
    ...
    static let wallBallAuraAlphaScalar: CGFloat = 0.10
    static let wallBallCoreAlphaScalar: CGFloat = 1.08
    static let wallBallCoreScaleScalar: CGFloat = 1.02
    static let wallBallContactScaleBoost: CGFloat = 0.0
    static let wallBallAuraMaxAlpha: CGFloat = 0.006
    static let wallBallAuraScale: CGFloat = 0.15
    static let wallBallWarningMaxAlpha: CGFloat = 0.030
    static let wallBallWarningScale: CGFloat = 0.28
    static let wallBallFocusMaxAlpha: CGFloat = 0.034
    static let wallBallFocusScale: CGFloat = 0.28
    static let wallBallRingGlowWidth: CGFloat = 0.75
    static let wallBallTailAlphaMultiplier: CGFloat = 0.10
    ...
    static let wallLaneGlowPeakGreat: CGFloat = 0.026
    static let wallLaneGlowPeakGood: CGFloat = 0.018
    static let wallLaneGlowWidth: CGFloat = 1.2
    ...
    static let wallContactProxyBallGlowWidth: CGFloat = 0.42
    ...
    static let wallContactBurstRingScaleMultiplier: CGFloat = 0.052
    static let wallContactBurstFlashScaleMultiplier: CGFloat = 0.020
    ...
    static let wallContactPocketApproachAlpha: CGFloat = 0.052
    static let wallContactPocketFillAlpha: CGFloat = 0.003
    static let wallContactPocketGlowBase: CGFloat = 0.10
    static let wallContactPocketGlowApproach: CGFloat = 0.42
    static let wallContactPocketScaleBase: CGFloat = 0.66
    static let wallContactPocketScaleApproach: CGFloat = 0.08
    static let wallContactProxyBallAuraScale: CGFloat = 0.22
    static let wallContactProxyBallFocusScale: CGFloat = 0.26
    static let wallReturnTrailAlphaMultiplier: CGFloat = 0.06
    static let wallReturnTrailWidthMultiplier: CGFloat = 0.20
    static let wallReturnTrailGlowMultiplier: CGFloat = 0.025
    static let wallReturnGhostAlphaMultiplier: CGFloat = 0.16
    static let wallReturnEchoAlphaMultiplier: CGFloat = 0.035
    ...
    static let wallLiveExchangeAuraAlphaMultiplier: CGFloat = 0.0
    static let wallLiveExchangeCoreAlphaMultiplier: CGFloat = 1.12
    static let wallLiveExchangeTailAlphaFloor: CGFloat = 0.024
    static let wallLiveExchangeTailAlphaRebound: CGFloat = 0.082
