...
enum Tunables {
    ...
    static let wallReturnTrailWidthMultiplier: CGFloat = 0.68
    static let wallReturnTrailGlowMultiplier: CGFloat = 0.42
    static let wallReturnGhostAlphaMultiplier: CGFloat = 0.76
    static let wallReturnEchoAlphaMultiplier: CGFloat = 0.56
    static let wallReturnImpactPulseAlphaMultiplier: CGFloat = 0.48
    ...
    static let footworkOutsideToeOutRadians: CGFloat = 0.21
