...
enum Tunables {
    ...
    static let wallBallAuraAlphaScalar: CGFloat = 0.16
    static let wallBallCoreAlphaScalar: CGFloat = 0.88
    static let wallBallCoreScaleScalar: CGFloat = 0.84
    static let wallBallContactScaleBoost: CGFloat = 0.0
    static let wallBallAuraMaxAlpha: CGFloat = 0.010
    static let wallBallAuraScale: CGFloat = 0.20
    ...
    static let wallContactProxyBallGlowWidth: CGFloat = 0.85
    static let wallContactProxyBallAuraAlpha: CGFloat = 0.006
    static let wallContactProxyBallCoreAlpha: CGFloat = 0.34
    ...
    static let wallLiveExchangeTailAlphaFloor: CGFloat = 0.035
    static let wallLiveExchangeTailAlphaRebound: CGFloat = 0.12
