    ...
    final class Coordinator: NSObject {
        ...
        func buildProceduralFigure(under anchor: AnchorEntity) {
            ...
            torso = Self.boxEntity(
                size: SIMD3<Float>(0.52, 0.44, 0.22),
                cornerRadius: 0.06,
            ...
            shorts = Self.boxEntity(
                size: SIMD3<Float>(0.54, 0.16, 0.23),
                cornerRadius: 0.05,
        ...
        @objc private func step(_ link: CADisplayLink) {
            ...
            case .idle:
                ...
                rightArm?.orientation = baseRightArmQ
                leftArm?.orientation = baseLeftArmQ
            ...
            case .shopLook:
                ...
                rightArm?.orientation = simd_mul(baseRightArmQ, simd_quatf(angle: -0.62, axis: SIMD3<Float>(0, 0, 1)))
                leftArm?.orientation = simd_mul(baseLeftArmQ, simd_quatf(angle: 0.38, axis: SIMD3<Float>(0, 0, 1)))
