...
|------------|------------|------|-----------------------------------|-------------------------------------------------|
| 2026-09-17 | (this commit) | [CX] | Repeat final test and thigh/shorts transition correction | Repeat1705suite passed307tests; owner then flagged exposed thighs. Tightened flared cuff fit, stabilized hem edge and made studio stance more upright. Body/leg geometry and approved gameplay/backhand motion unchanged. Final309executed/308passed/1fixture skip/0failures; two known Vision exclusions. Simulator and signed1706 builds/packet pass; all-six native roster and leg/motion proofs reviewed, lefty Clean Eight14-shot run complete. UI/owner/phone acceptance remain VERIFY. See docs/RALLY_THIGH_POLISH_SEPT17.md. |
| 2026-09-17 | (this commit) | [CX] | Final finishing touches and both-phone packet | Owner approved the revised backhand; its motion is preserved. Fixed oversized wall ball through contact/return handoffs, Shop bag/details routing and tap targets, World accessibility text layout, and underlying court controls on results. Final suite: 308 executed, 307 passed, one fixture skip, zero failures; two existing Vision exclusions. Simulator/signed1705 builds and both-phone package checks pass; native Clean Eight run completed with 14-shot streak. Interactive UI and physical-phone acceptance remain VERIFY because Mac relocked. See docs/RALLY_FINAL_POLISH_SEPT17.md. |
| 2026-09-17 | (this commit) | [CX] | Rework rejected backhand model and live preparation | Replaced upright racket/high crossed hands with phased drop, lower forward contact and shoulder wrap; unit turn, stable palm frame, authored tee occlusion and incoming-ball preparation. All six athletes/both hands reviewed from front/game camera. Final suite306executed/305passed/1fixture skip/0failures, two known Vision exclusions; simulator and signed1704 builds pass. Both-hand live autoplay completed14-shotstreaks. New both-phone packet verifies; physical feel and owner visual acceptance remain VERIFY. See docs/RALLY_BACKHAND_REWORK_SEPT17.md. |
| 2026-09-17 | (this commit) | [CX] | Handed two-handed backhand, Shop photos, World links and gameplay feel | Opening hand choice drives both court players; attached supporting grip, shoulder unwind, serve recovery, quieter contact feedback and optional Clean Eight goal. 32 bundled official photos cover paid merchandise; World has site/maps actions and repaired URLs. Final native suite: 294 executed, 293 passed, one fixture skip, zero failures; two known Vision exclusions. Generic simulator and signed device builds passed. Build2026091703 packet validates both phones. Final Shop/World/hand-selector taps and physical feel remain VERIFY; Mac locked. See docs/RALLY_GAMEPLAY_FEEL_SEPT17.md. |
| 2026-09-17 | (this commit) | [CX] | Shared athlete, equipment, movement and court polish | Clean clothing/shoe fit, smoother stroke recovery, Retina court detail, calmer Home/Shop/Coach, safe-area HUD and restrained hit effects. Generic simulator/signed device builds and 265 native tests passed; one fixture skip and two known Vision exclusions. Actual render/Home/game/autoplay evidence reviewed; Shop/detail/smaller-phone and physical performance remain VERIFY. See docs/RALLY_VISUAL_POLISH_SEPT17.md. |
| 2026-09-05 | (this commit) | [CX] | 20-second Mirror Rally + moving feet | Same athlete/outfit at both ends; grounded lead/trailing steps, early preparation, projected racket contacts, .76/.70/.64-second pulse, swipe-anywhere timing/aim, finite timer and compact replay. Fixed premature first-feed misses, skipped far impacts and contact-deadline drift. 176 full-suite tests plus 15 final scene/rig checks passed; generic simulator build passed. Animation proof and limitations in RALLY_MIRROR_RALLY.md. Live UI/device feel remains unverified because the Mac locked during testing. |
| 2026-09-05 | (this commit) | [CX] | Generic model colors + exact garment intake | Six unnamed models; skin/hair material controls retain fixed body/garment geometry. Six official product/colorway records, five verified-price shop entries, exact-ID photo resolver, NB tank photo correction, product details and per-body mesh registry; current clothes explicitly remain generic style previews. 136 full-suite tests + final 8 garment tests passed (137 distinct); seven backend tests and generic simulator build passed. Proof gallery refreshed; first exact 3D garment remains pending. |
| 2026-09-05 | (this commit) | [CX] | Six fixed 3D tennis players + rhythmic flick gameplay | Shared SceneKit rig replaces duplicate 2D characters. Three men/three women with authored European/Asian/Black faces, two stable athletic garment fits, realistic textures, rotatable previews and planted ready stance. Six-player roster replaces identity editing and persists through compatible sync. Flick release timing, directional arc, contracting beat ring and escalating combos define the skill loop; fast pans retain their touch origin. Build, tests and simulator proof in `RALLY_3D_REBUILD.md`. |
