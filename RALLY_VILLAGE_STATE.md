...
| Phone Court | Ready for test | `RALLY_REAL_PHONE_INSTALL.md` now leads into `RALLY_REAL_PHONE_TEST.md` and `RALLY_REAL_PHONE_RESULTS.md` for install, real-device pass/fail testing, and top-three bug capture. Current tree build passed on 2026-07-04. |
