...
|------------------|-------|--------------|--------|-------|
| 2026-06-26 | [CX] | Rafa avatar/gameplay credibility — `Rally/Features/Avatar/RallyAvatarGeometry.swift`, `Rally/Features/Avatar/RallyAvatarView.swift`, `Rally/Game/GameScene.swift` avatar consumption, `RALLY_VISUAL_QA.md` | ACTIVE | Owner-visible defect remains: player still reads puppet-like at gameplay scale. Claiming hot zone before tuning shared anatomy/head/feet through the existing avatar pipeline. |
