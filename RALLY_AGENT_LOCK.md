...
|------------------|-------|--------------|--------|-------|
| 2026-07-01 | [CC] | Sync data-loss fix — `Rally/Services/RallySyncCoordinator.swift`, `RALLY_PROGRESS.md` row append | ACTIVE | Replacing delete-all-then-insert with id-based merge for TrainingSession/MatchEntry/JournalEntry per 2026-06-16 BLOCKED note. Owner approved BUILD NOT RUN risk in chat 2026-07-01. |
