...
|------------------|-------|--------------|--------|-------|
| 2026-06-18 | [CX] | Rafa no-ball recovery — `Rally/Game/GameScene.swift`, `Rally/Game/Tunables.swift` | ACTIVE | Re-checking the empty-court/dead-air report after the user saw no balls coming through. |
