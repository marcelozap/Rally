...
|------------------|-------|--------------|--------|-------|
| 2026-09-17 | [CX] | Visual polish: shared avatar rig/view/customizer, court backdrop/palette, Home/Shop/Locker stages, app theme/tab chrome, GameScene HUD and GameSessionView, Coach presentation; focused visual tests/proof docs | ACTIVE | Owner requested all graphics/visuals improved before September 18; authorized relocated checkout and latest phone-building integration state. Branch codex/rally-visual-polish-sept17 from e97b511. Agents use separate file ownership; root integrates/builds. Preserve app identity, gameplay rules and user data; prepare signed build for both known phones, no install before tonight. |
