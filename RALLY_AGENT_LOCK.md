...
|------------------|-------|--------------|--------|-------|
| 2026-09-05 | [CX] | Gameplay footwork — shared avatar rig, locomotion helper/tests, GameScene court movement, Tunables as needed, project registration and proof/progress | ACTIVE | Owner reports fixed feet on wide balls. Implement travel-driven lateral steps, planted contact and recovery using the existing fixed body/garment rigs. Same authorized relocated checkout. |
