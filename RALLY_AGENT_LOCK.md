...
|------------------|-------|--------------|--------|-------|
| 2026-06-27 | [CX] | Avatar anatomy readability — `Rally/Features/Avatar/RallyAvatarGeometry.swift`, `Rally/Features/Avatar/RallyAvatarView.swift`, `Rally/Game/GameScene.swift` avatar consumption, `RALLY_VISUAL_QA.md` | ACTIVE | Owner-facing screenshots still call out puppet face, weak shoulders, fragile hair/ears, and inward feet. Claiming one shared-geometry readability pass; no gameplay physics or shop changes. |
