...
|------------------|-------|--------------|--------|-------|
| 2026-09-05 | [CX] | Generic athlete labels + skin/hair colors; `Rally/Features/Avatar/`, avatar config/sync/tests, Home label, product modeling catalog/resources and source documentation | ACTIVE | Owner simplified models to unnamed defaults with only color choices and shifted priority to real clothing from real brands. Same authorized relocated checkout; preserve unowned handoff/textClipping. |
