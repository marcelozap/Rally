...
|------------------|-------|--------------|--------|-------|
| 2026-06-18 | [CX] | Avatar anatomy readability — `Rally/Features/Avatar/RallyAvatarGeometry.swift`, `Rally/Features/Avatar/RallyAvatarView.swift`, `Rally/Game/GameScene.swift` | ACTIVE | Focused pass on face/mouth/ears/hair connection and foot toe-out using shared geometry/consumption only; no product UI or gameplay physics changes. |
