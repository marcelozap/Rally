...
|------------------|-------|--------------|--------|-------|
| 2026-07-01 | [CC] | Rafa gameplay feel polish — `Rally/Game/GameScene.swift` (effects/HUD, NOT avatar-assembly block), `Rally/Game/Tunables.swift`, `RALLY_PROGRESS.md` row append | ACTIVE | T4 continuation: contact-glow face occlusion at exact hit frame (open item from 2026-06-26 release note) + feel polish. No avatar drawing added to GameScene per T5 debt rule. |
