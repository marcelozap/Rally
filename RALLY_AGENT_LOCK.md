...
| 2026-09-08 | [CX] | Rally Coach device integration: Coach sources/tests, Home and Training entry points, Xcode registration and validation docs | ACTIVE | Owner authorized continuation in the verified relocated checkout on codex/rally-coach-device, preserving local signing, version handling and shipping files. Integrate prepared native branch, run Mac tests/builds, install in place and record actual device evidence. |
