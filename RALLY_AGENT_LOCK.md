...
|------------------|-------|--------------|--------|-------|
| 2026-06-27 | [CX] | Rafa contact payoff readability — `Rally/Game/GameScene.swift`, `Rally/Game/Tunables.swift`, `RALLY_VISUAL_QA.md` | ACTIVE | Last proof shows live scoring but contact glow covers the avatar face at hit frame. Claiming effect-layer/placement tuning only; no avatar anatomy changes. |
