...
|------------------|-------|--------------|--------|-------|
| 2026-09-17 | [CX] | Owner-requested thigh/shorts transition correction: shared avatar rig/mesh helpers, targeted anatomy/pose/render tests, verification and revised signed handoff | RELEASED | Tapered generic shorts cuff clearance and preserved hem edge; relaxed studio pelvis/knee stance while keeping body geometry, lower-leg anatomy and gameplay/backhand pose intact. Final309executed/308passed/1fixture skip/0failures; two known Vision exclusions. Native six-athlete roster,12leg closeups and both-hand backhand sheets reviewed. Simulator/signed1706 builds and both-phone packet checks pass; lefty fullchallenge completed14-shot streak. Owner visual acceptance, remaining interactive UI and physical-phone checks remain VERIFY; Mac relocked. See docs/RALLY_THIGH_POLISH_SEPT17.md. |
| 2026-09-17 | [CX] | Final finishing pass: gameplay contact visibility/feedback, Shop and World presentation/accessibility, focused verification, release instructions and signed packet | RELEASED | Preserved owner-approved backhand; corrected oversized contact ball, Shop bag/details routing and tap targets, World large-text layout, and covered court accessibility. Final suite: 308 executed, 307 passed, one fixture skip, zero failures; two known Vision exclusions. Simulator and signed1705 builds pass; native Clean Eight run completed with 14-shot streak. Both-phone packet checks pass. Final interactive UI and physical-phone acceptance remain VERIFY; Mac relocked. See docs/RALLY_FINAL_POLISH_SEPT17.md. |
| 2026-09-17 | [CX] | Backhand modeling revision: shared avatar rig, backhand body/arm/racket kinematics, garment deformation as needed, focused rig/render tests, gameplay animation integration and signed handoff | RELEASED | Reworked owner-rejected build2026091703 pose: sideways contact racket, lower forward hands, unit turn/drop/wrap, stable palm frame, tee occlusion and incoming preparation.306executed/305passed/1fixture skip/0failures; two known Vision exclusions. All six athletes/both hands rendered; both-hand live autoplay completed. Simulator/signed1704 builds and both-phone packet verification passed. Physical installs and owner visual acceptance remain VERIFY. Same owner-authorized relocated checkout. See docs/RALLY_BACKHAND_REWORK_SEPT17.md. |
| 2026-09-17 | [CX] | Gameplay feel: shared rig/footwork/two-handed backhand and opening hand choice, audio/haptics, mirror rules/GameScene, Play hub/session/results, short-challenge model/UI, World location links, Shop product imagery/catalog, focused tests, project registration and handoff | RELEASED | Owner-authorized relocated checkout. Implemented handed two-handed backhand, serve recovery, contact feedback, Clean Eight, World site/maps actions and 32 bundled official product photos. Final suite: 294 executed, 293 passed, one fixture skip, zero failures; two known Vision exclusions. Generic simulator and signed device builds passed; build2026091703 packet verifies both phones. Physical installs remain for tonight; final Shop/World/hand-selector taps remain VERIFY because Mac locked. Details: docs/RALLY_GAMEPLAY_FEEL_SEPT17.md. |
| 2026-09-17 | [CX] | Visual polish: shared avatar rig/view/customizer, court backdrop/palette, Home/Shop/Locker stages, app theme/tab chrome, GameScene HUD and GameSessionView, ParticleManager hit-effect rendering, Coach presentation; focused visual tests/proof docs | RELEASED | Generic simulator and signed device builds passed. Final native suite: 266 executed, 265 passed, one fixture skip, zero failures; two prior Vision-model exclusions retained. Roster/equipment/stroke and live Home/game/autoplay proof reviewed. Signed build 2026091702 prepared for both phones; physical install and locked-Mac Shop/detail/smaller-phone walkthrough remain VERIFY. Details: docs/RALLY_VISUAL_POLISH_SEPT17.md. |
| 2026-09-08 | [CX] | Native visual Coach lesson, serve-first lifecycle and practice modes; Coach, GameScene, avatar instructional pose, mode selection, explicit Xcode source registration, focused tests and integration docs | ACTIVE | Owner authorized full implementation from latest phone-building state and relocated checkout. Integration branch codex/rally-visual-lessons-integration starts at 2a488ce. Preserve identity, saved data, outfits and existing gated diagnostics. No release or installation on an unidentified phone. |
| 2026-09-07 | [CX] | Rally Coach additive feature (`Rally/Features/Coach/`), focused tests and package, Home toolbar and Training entry points, Xcode registration, Coach handoff docs | RELEASED | Windows preparation finished September 8 on `codex/rally-coach-ios` from `rally/dev` at 481157f. 41 portable tests passed, 2 symlink tests skipped; Swift syntax and Xcode project structure checked. Apple SDK build, Vision runtime, screenshots and iPhone verification remain for the laptop; follow RALLY_COACH_LAPTOP_PROMPT.md. Existing gameplay, avatar, commerce, sync and local laptop tweaks preserved. |
...
| 2026-09-08 | [CX] | Rally Coach device integration: Coach sources/tests, Home and Training entry points, Xcode registration and validation docs | RELEASED | Integrated prepared branch with local signing/assets preserved. Generic simulator build and 44 portable tests pass; 226 iOS tests pass with one missing-simulator-model test excluded. Device/UI checks remain recorded in docs/RALLY_COACH_VALIDATION.md. Owner requested follow-up kinematics work on a separate branch. |
| 2026-09-08 | [CX] | Rally Coach adaptive smoothing, shoulder-relative arm motion, hand selection, timeline, focused tests and source registration | RELEASED | Implemented gated native review on codex/rally-coach-kinematics. Final 63 portable tests and generic build pass; simulator suite has 247 executed/1 skipped/0 failures, two model-dependent exclusions. Earlier 73 Coach tests passed on iPhone with real footage. Final signed app installed in place; final device rerun blocked by phone lock. Data hashes preserved; validation docs record limits and remaining UI checks. |
