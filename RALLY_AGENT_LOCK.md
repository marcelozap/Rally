...
|------------------|-------|--------------|--------|-------|
| 2026-06-18 | [CX] | Rafa wall-rally no-ball watchdog — `Rally/Game/GameScene.swift`, `Rally/Game/Tunables.swift` | ACTIVE | Claiming one focused pass to make empty-court feed recovery more aggressive and observable. |
