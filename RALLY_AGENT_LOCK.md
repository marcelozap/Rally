...
| 2026-09-08 | [CX] | Rally Coach adaptive smoothing, shoulder-relative arm motion, hand selection, timeline, focused tests and source registration | ACTIVE | Owner requested selected gateKPT algorithms in native Swift on codex/rally-coach-kinematics. Preserve baseline reports and experience; gate unvalidated measurements; record raw/filtered comparisons, 10 Hz limitations and actual device evidence. |
