...
|------------------|-------|--------------|--------|-------|
| 2026-06-22 | [CX] | Rafa contact glow readability — `Rally/Game/GameScene.swift`, `Rally/Game/Tunables.swift`, `RALLY_VISUAL_QA.md` | ACTIVE | Narrow pass to reduce broad wall-contact glow spillover around the avatar silhouette, build, capture autoplay proof, then release. |
