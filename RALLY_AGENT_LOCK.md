...
|------------------|-------|--------------|--------|-------|
| 2026-09-05 | [CX] | Shared 3D character rebuild — `Rally/Features/Avatar/`, `Rally/Game/GameScene.swift` avatar integration, Home/Shop stages, model resources, project registration, avatar tests and progress/proof docs | ACTIVE | Owner requested realistic character models for clothing commerce after locating this relocated repo at `Desktop/_XIV Desktop System/99 Inbox - To Sort/Rally`; verified `rally/dev`, origin, and 2a348f5. Preserve existing handoff and textClipping edits. Subagents use explicit disjoint scopes. |
