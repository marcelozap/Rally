...
|------------------|-------|--------------|--------|-------|
| 2026-06-18 | [CX] | Rafa wall-rally ball feed reliability — `Rally/Game/GameScene.swift`, `Rally/Game/Tunables.swift` | ACTIVE | Investigate and patch the empty-court/no-balls-coming-through failure without touching avatar or Shop files. |
